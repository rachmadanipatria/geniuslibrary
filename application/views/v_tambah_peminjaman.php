                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST" action="<?php echo base_url();?>index.php/transaksi/tambahDataPeminjaman">
                                ...
                                <a type="reset" href="<?php echo base_url();?>index.php/transaksi/" class="btn btn-default">Batal</a>
                            </form>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
